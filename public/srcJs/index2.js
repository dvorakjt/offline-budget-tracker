import { activateDb } from "./activateDb";
import { readDatabase } from "./readDatabase";
import { recordTransaction } from "./recordDbTransaction";
...
(async () => {
    db = await activateDb();
    console.log(db);
    window.addEventListener("online", () => { readDatabase(db) });
})();
...
function sendTransaction(isAdding) {
    ...
    fetch("/api/transaction", {
        ...
        .catch(err => {
            ...
            recordTransaction(transaction, db);
